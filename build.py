...
if configure(settings):
    ...
    buildMake('', ['hermes', 'hmsextmodule', 'hmsextjni', 'hmsextaassetreader', 'hmsextserializer'] if settings.mBuildTarget == 'android' else ['hermes', 'hmsextmodule', 'hmsextserializer'], settings, '')
    cleanup(settings)
