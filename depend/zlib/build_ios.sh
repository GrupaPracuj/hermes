...
rm -f ${WORKING_DIR}/../../lib/ios/libzlib.a
...
for ((i=0; i<${#ARCH[@]}; i++)); do
	...
	if make $1 -j${CPU_CORE}; then
        cp libzlib.a ${TMP_LIB_DIR}/libzlib-${ARCH_NAME[$i]}.a
	fi
...
cd ${TMP_LIB_DIR}
lipo -create -output "libzlib.a" "libzlib-armv7.a" "libzlib-armv7s.a" "libzlib-arm64.a" "libzlib-x86.a" "libzlib-x86_64.a"
cp ${TMP_LIB_DIR}/libzlib.a ${WORKING_DIR}/../../lib/ios/
